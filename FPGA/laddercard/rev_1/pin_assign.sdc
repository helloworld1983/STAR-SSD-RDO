...
# Attributes
#
define_attribute -disable {b:dbg_ladder_fpga_sc_bypass} {altera_chip_pin_lc} {@A3}
define_attribute {b:fibre_mod_scl} {altera_chip_pin_lc} {@G4}
define_attribute {b:usb_tx_full} {altera_chip_pin_lc} {@A6}
...
define_attribute {b:ladder_fpga_sc_trstb} {altera_chip_pin_lc} {@AB11}
...
define_attribute {b:sc_serdes_ou_connec} {altera_chip_pin_lc} {@A8}
define_attribute {b:clock80mhz_adc} {altera_chip_pin_lc} {@AA3}
define_attribute {b:rdo_to_ladder[13]} {altera_chip_pin_lc} {@AA5}
define_attribute {b:des_bist_pass} {altera_chip_pin_lc} {@W2}
...
define_attribute {b:testin_echelle} {altera_chip_pin_lc} {@AA11}
define_attribute {b:reset_n} {altera_chip_pin_lc} {@A11}
...
define_attribute {b:ladder_fpga_sc_tdo} {altera_chip_pin_lc} {@AA1}
define_attribute {b:fpga_serdes_ou_connec} {altera_chip_pin_lc} {@C10}
define_attribute {b:sc_tdi_hybride[5]} {altera_chip_pin_lc} {@AB9}
define_attribute {b:data_serial[12]} {altera_chip_pin_lc} {@AB10}
define_attribute {b:ladder_fpga_sc_tck} {altera_chip_pin_lc} {@T2}
define_attribute {b:tokenin_echelle} {altera_chip_pin_lc} {@AB12}
...
define_attribute {b:level_shifter_dac_sdi} {altera_chip_pin_lc} {@V9}
...
define_attribute {b:usb_present} {altera_chip_pin_lc} {@Y2}
...
define_attribute {b:usb_reset_n} {altera_chip_pin_lc} {@A7}
...
define_attribute {b:usb_read_n} {altera_chip_pin_lc} {@T4}
...
define_attribute {b:clock40mhz_xtal} {altera_chip_pin_lc} {@G1}
define_attribute {b:clock40mhz_fpga} {altera_chip_pin_lc} {@G2}
define_attribute {b:ladder_fpga_sc_tms} {altera_chip_pin_lc} {@G3}
...
define_attribute {b:ladder_fpga_sc_tdi} {altera_chip_pin_lc} {@Y7}
...
define_attribute {b:hold_16hybrides} {altera_chip_pin_lc} {@K18}
...
define_attribute {b:crc_error} {altera_chip_pin_lc} {@L21}
...
define_attribute -disable {b:dbg_ladder_fpga_adc_bit_count_cs_integer[0]} {altera_chip_pin_lc} {@E5}
...
define_attribute {b:usb_rx_empty} {altera_chip_pin_lc} {@M22}
...
define_attribute {b:usb_ready_n} {altera_chip_pin_lc} {@AB14}
...
define_attribute {b:temperature} {altera_chip_pin_lc} {@E3}
define_attribute {b:fibre_tx_fault} {altera_chip_pin_lc} {@H2}
...
define_attribute {b:ladder_fpga_rclk_16hybrides} {altera_chip_pin_lc} {@A15}
...
define_attribute {b:fibre_mod_absent} {altera_chip_pin_lc} {@W1}
define_attribute {b:tokenin_hybride[8]} {altera_chip_pin_lc} {@A20}
define_attribute {b:level_shifter_dac_sck} {altera_chip_pin_lc} {@T10}
...
define_attribute {b:debug_present_n} {altera_chip_pin_lc} {@B3}
define_attribute {b:des_lock} {altera_chip_pin_lc} {@V2}
define_attribute {b:rdo_to_ladder[19]} {altera_chip_pin_lc} {@V5}
define_attribute {b:holdin_echelle} {altera_chip_pin_lc} {@V8}
define_attribute {b:fibre_mod_sda} {altera_chip_pin_lc} {@B10}
define_attribute {b:xtal_en} {altera_chip_pin_lc} {@D17}
...
define_attribute {b:spare_switch} {altera_chip_pin_lc} {@E4}
define_attribute -disable {b:dbg_ladder_fpga_adc_bit_count_cs_integer[3]} {altera_chip_pin_lc} {@F2}
define_attribute -disable {b:dbg_ladder_fpga_adc_bit_count_cs_integer[1]} {altera_chip_pin_lc} {@W7}
define_attribute -disable {b:dbg_ladder_fpga_adc_bit_count_cs_integer[2]} {altera_chip_pin_lc} {@W8}
...
define_attribute {b:fibre_tx_disable} {altera_chip_pin_lc} {@Y1}
define_attribute {b:test_16hybrides} {altera_chip_pin_lc} {@F13}
define_attribute {b:fibre_rx_loss} {altera_chip_pin_lc} {@D6}

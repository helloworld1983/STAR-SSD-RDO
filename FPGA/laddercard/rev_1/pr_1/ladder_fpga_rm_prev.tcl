...
set_instance_assignment -name io_standard "2.5 V" -to "clock80mhz_adc" -remove
set_instance_assignment -name io_standard "2.5 V" -to "roboclock_horloge40_phase\[0\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "roboclock_horloge40_phase\[1\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "roboclock_horloge40_phase\[2\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "roboclock_horloge40_phase\[3\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "roboclock_adc_phase\[0\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "roboclock_adc_phase\[1\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "roboclock_adc_phase\[2\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "roboclock_adc_phase\[3\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "roboclock_adc_phase\[4\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "roboclock_adc_phase\[5\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "roboclock_adc_phase\[6\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "roboclock_adc_phase\[7\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "adc_cs_n\[0\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "adc_cs_n\[1\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "adc_cs_n\[2\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "adc_cs_n\[3\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "adc_cs_n\[4\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "adc_cs_n\[5\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "adc_cs_n\[6\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "adc_cs_n\[7\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "level_shifter_dac_ld_cs_n" -remove
set_instance_assignment -name io_standard "2.5 V" -to "level_shifter_dac_sdi" -remove
set_instance_assignment -name io_standard "2.5 V" -to "level_shifter_dac_sck" -remove
set_instance_assignment -name io_standard "2.5 V" -to "pilotage_magnd_hybride\[0\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "pilotage_magnd_hybride\[1\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "pilotage_magnd_hybride\[2\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "pilotage_magnd_hybride\[3\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "pilotage_magnd_hybride\[4\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "pilotage_magnd_hybride\[5\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "pilotage_magnd_hybride\[6\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "pilotage_magnd_hybride\[7\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "pilotage_magnd_hybride\[8\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "pilotage_magnd_hybride\[9\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "pilotage_magnd_hybride\[10\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "pilotage_magnd_hybride\[11\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "pilotage_magnd_hybride\[12\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "pilotage_magnd_hybride\[13\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "pilotage_magnd_hybride\[14\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "pilotage_magnd_hybride\[15\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "pilotage_mvdd_hybride\[0\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "pilotage_mvdd_hybride\[1\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "pilotage_mvdd_hybride\[2\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "pilotage_mvdd_hybride\[3\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "pilotage_mvdd_hybride\[4\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "pilotage_mvdd_hybride\[5\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "pilotage_mvdd_hybride\[6\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "pilotage_mvdd_hybride\[7\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "pilotage_mvdd_hybride\[8\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "pilotage_mvdd_hybride\[9\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "pilotage_mvdd_hybride\[10\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "pilotage_mvdd_hybride\[11\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "pilotage_mvdd_hybride\[12\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "pilotage_mvdd_hybride\[13\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "pilotage_mvdd_hybride\[14\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "pilotage_mvdd_hybride\[15\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "ladder_to_rdo\[0\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "ladder_to_rdo\[1\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "ladder_to_rdo\[2\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "ladder_to_rdo\[3\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "ladder_to_rdo\[4\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "ladder_to_rdo\[5\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "ladder_to_rdo\[6\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "ladder_to_rdo\[7\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "ladder_to_rdo\[8\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "ladder_to_rdo\[9\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "ladder_to_rdo\[10\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "ladder_to_rdo\[11\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "ladder_to_rdo\[12\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "ladder_to_rdo\[13\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "ladder_to_rdo\[14\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "ladder_to_rdo\[15\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "ladder_to_rdo\[16\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "ladder_to_rdo\[17\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "ladder_to_rdo\[18\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "ladder_to_rdo\[19\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "ladder_to_rdo\[20\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "ladder_to_rdo\[21\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "ladder_fpga_sc_tdo" -remove
set_instance_assignment -name io_standard "2.5 V" -to "fibre_tx_disable" -remove
set_instance_assignment -name io_standard "2.5 V" -to "mux_ref_latchup\[0\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "mux_ref_latchup\[1\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "test_16hybrides" -remove
set_instance_assignment -name io_standard "2.5 V" -to "hold_16hybrides" -remove
set_instance_assignment -name io_standard "2.5 V" -to "ladder_fpga_rclk_16hybrides" -remove
set_instance_assignment -name io_standard "2.5 V" -to "tokenin_hybride\[0\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "tokenin_hybride\[1\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "tokenin_hybride\[2\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "tokenin_hybride\[3\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "tokenin_hybride\[4\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "tokenin_hybride\[5\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "tokenin_hybride\[6\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "tokenin_hybride\[7\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "tokenin_hybride\[8\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "tokenin_hybride\[9\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "tokenin_hybride\[10\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "tokenin_hybride\[11\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "tokenin_hybride\[12\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "tokenin_hybride\[13\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "tokenin_hybride\[14\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "tokenin_hybride\[15\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tck_hybride\[0\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tck_hybride\[1\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tck_hybride\[2\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tck_hybride\[3\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tck_hybride\[4\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tck_hybride\[5\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tck_hybride\[6\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tck_hybride\[7\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tck_hybride\[8\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tck_hybride\[9\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tck_hybride\[10\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tck_hybride\[11\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tck_hybride\[12\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tck_hybride\[13\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tck_hybride\[14\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tck_hybride\[15\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tms_hybride\[0\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tms_hybride\[1\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tms_hybride\[2\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tms_hybride\[3\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tms_hybride\[4\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tms_hybride\[5\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tms_hybride\[6\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tms_hybride\[7\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tms_hybride\[8\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tms_hybride\[9\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tms_hybride\[10\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tms_hybride\[11\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tms_hybride\[12\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tms_hybride\[13\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tms_hybride\[14\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tms_hybride\[15\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_trstb_hybride\[0\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_trstb_hybride\[1\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_trstb_hybride\[2\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_trstb_hybride\[3\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_trstb_hybride\[4\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_trstb_hybride\[5\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_trstb_hybride\[6\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_trstb_hybride\[7\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_trstb_hybride\[8\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_trstb_hybride\[9\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_trstb_hybride\[10\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_trstb_hybride\[11\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_trstb_hybride\[12\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_trstb_hybride\[13\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_trstb_hybride\[14\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_trstb_hybride\[15\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tdi_hybride\[0\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tdi_hybride\[1\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tdi_hybride\[2\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tdi_hybride\[3\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tdi_hybride\[4\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tdi_hybride\[5\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tdi_hybride\[6\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tdi_hybride\[7\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tdi_hybride\[8\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tdi_hybride\[9\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tdi_hybride\[10\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tdi_hybride\[11\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tdi_hybride\[12\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tdi_hybride\[13\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tdi_hybride\[14\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "sc_tdi_hybride\[15\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "usb_read_n" -remove
set_instance_assignment -name io_standard "2.5 V" -to "usb_write" -remove
set_instance_assignment -name io_standard "2.5 V" -to "dbg_ladder_fpga_adc_bit_count_cs_integer\[0\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "dbg_ladder_fpga_adc_bit_count_cs_integer\[1\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "dbg_ladder_fpga_adc_bit_count_cs_integer\[2\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "dbg_ladder_fpga_adc_bit_count_cs_integer\[3\]" -remove
set_instance_assignment -name io_standard "2.5 V" -to "dbg_ladder_fpga_sc_bypass" -remove
